    ...
    <>
        ...
        <Container>
            ...
            <Container className="text-start mt-5">
                <h2>In evidenza</h2>
                <Row>
                    <Col className="col-3 border border-black ps-3 py-3 m-2 d-flex flex-column justify-content-between shadow">
                    ...
                    <Col className="col-4 border border-black ps-3 py-3 m-2 d-flex flex-column justify-content-between shadow">
